...
class ContentItem extends Model
{
    ...
    protected $fillable = ['title','slug','excerpt','body','primary_keyword','search_intent','status','health_score','seo_score','risk_score','meta_title','meta_description','published_at'];
